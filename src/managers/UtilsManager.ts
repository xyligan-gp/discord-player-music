...
export class UtilsManager {
   ...
   * @param {number[]} data numbers Array
   *
   * @example
   ...
   *
   * @returns {string[]} Returns an array of formatted numbers
   */
  ...
  public formatDuration(value: number): string {
    ...
    const durationData = this.formatnumbers([
      duration.hours,
      duration.minutes,
      duration.seconds,
    ]);
  ...
  public checkOptions(options?: PlayerOptions): PlayerOptions {
    if (!options) {
      ...
      if (typeof options?.autoAddingTracks != "boolean") {
        options.autoAddingTracks = true;
      }

      if (
        !options.searchResultsLimit ||
        typeof options.searchResultsLimit != "number"
      ) {
        options.searchResultsLimit = 10;
      }

      if (!options.synchronLoop || typeof options.synchronLoop != "boolean") {
        options.synchronLoop = true;
      }

      if (!options.defaultVolume || typeof options.defaultVolume != "number") {
        options.defaultVolume = 5;
      }

      if (
        !options.databaseConfig ||
        typeof options.databaseConfig != "object"
      ) {
        options.databaseConfig = {
          path: "./dpm.playlists.json",
          checkInterval: "5s",
        ...
        if (
          ...
          typeof options.databaseConfig.path != "string"
        ) {
          options.databaseConfig.path = "./dpm.playlists.json";
        }

        if (
          !options.databaseConfig.checkInterval ||
          typeof options.databaseConfig.checkInterval != "string"
        ) {
          options.databaseConfig.checkInterval = "5s";
        }
      }

      if (
        !options.progressConfig ||
        typeof options.progressConfig != "object"
      ) {
        options.progressConfig = {
          size: 11,
          line: "▬",
        ...
        if (
          ...
          typeof options.progressConfig.size != "number"
        ) {
          options.progressConfig.size = 11;
        }

        if (
          !options.progressConfig.line ||
          typeof options.progressConfig.line != "string"
        ) {
          options.progressConfig.line = "▬";
        }
        ...
        if (
          ...
          typeof options.progressConfig.slider != "string"
        ) {
          options.progressConfig.slider = "🔘";
        }
      }
      ...
      if (
        ...
        typeof options.collectorsConfig != "object"
      ) {
        options.collectorsConfig = {
          message: {
            time: "1m",
        ...
        if (
          ...
          typeof options.collectorsConfig.message != "object"
        ) {
          options.collectorsConfig.message = {
            time: "1m",
            attempts: 1,
          ...
          if (
            ...
            typeof options.collectorsConfig.message.time != "string"
          ) {
            options.collectorsConfig.message.time = "1m";
          }

          if (
            !options.collectorsConfig.message.attempts ||
            typeof options.collectorsConfig.message.attempts != "number"
          ) {
            options.collectorsConfig.message.attempts = 1;
          }
        }

        if (
          !options.collectorsConfig.reaction ||
          typeof options.collectorsConfig.reaction != "object"
        ) {
          options.collectorsConfig.reaction = {
            time: "30s",
            attempts: 1,
          ...
          if (
            ...
            typeof options.collectorsConfig.reaction.time != "string"
          ) {
            options.collectorsConfig.reaction.time = "30s";
          }

          if (
            !options.collectorsConfig.reaction.attempts ||
            typeof options.collectorsConfig.reaction.attempts != "number"
          ) {
            options.collectorsConfig.reaction.attempts = 1;
          }

          if (
            !options.collectorsConfig.reaction.reactions ||
            !options.collectorsConfig.reaction.reactions?.length
          ) {
            options.collectorsConfig.reaction.reactions = [
              "1⃣",
              "2⃣",
